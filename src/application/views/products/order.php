...
foreach ($products as $k => $item) {
        ...
        ?>
            <tr>
                <td style="text-align:left;" class="plr-5"><img src="<?php echo $item["image_url"]; ?>"
                ...
                <td style="text-align:center;" class="plr-5"><a
                        href="/products/order?action=remove&id=<?php echo $k; ?>" class="btnRemoveAction"><i
    ...
    ?>
            ...
            <tr>
                ...
                <td align="right" colspan="2" class="plr-5">
                    <strong><?php echo number_format($total_price, 0) . "đ"; ?></strong></td>
                <td></td>
            </tr>
        </tbody>
    </table>
